...
### April 13, 2026 (Org Settings Inheritance)
- WEB: Season creation now reads fee defaults from organization.settings → Mobile season creation should read same defaults
- WEB: Registration Form Builder removed from required setup sections → Mobile org setup should verify same
- WEB: Organization settings page now has "Complete Setup" button → Mobile should verify setup_complete can be set from settings
