...
const createStyles = (colors: any) => StyleSheet.create({
  ...
  title: { fontSize: 28, fontFamily: FONTS.bodyExtraBold, color: colors.text },
  ...
  coachInfo: { flex: 1 },
  coachName: { fontSize: 18, fontFamily: FONTS.bodySemiBold, color: colors.text },
  ...
  createBtnTxt: { color: colors.background, fontSize: 18, fontFamily: FONTS.bodyBold },
  ...
  detailTitle: { fontSize: 20, fontFamily: FONTS.bodyBold, color: colors.text },
  ...
  initialsLg: { color: colors.primary, fontSize: 32, fontFamily: FONTS.bodyBold },
  coachNameLg: { fontSize: 24, fontFamily: FONTS.bodyBold, color: colors.text },
  section: { backgroundColor: colors.background, borderRadius: 12, padding: 16, marginBottom: 16 },
  sectionTitle: { fontSize: 13, fontFamily: FONTS.bodyBold, color: colors.textMuted, marginBottom: 12, textTransform: 'uppercase' as const, letterSpacing: 1 },
  ...
  roleHead: { color: colors.primary, fontFamily: FONTS.bodyBold },
  ...
  assignBtnTxt: { fontSize: 12, color: colors.success, fontFamily: FONTS.bodySemiBold },
});