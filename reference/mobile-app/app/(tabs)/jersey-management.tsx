...
const createStyles = (colors: any) => StyleSheet.create({
  ...
  subtitle: { fontSize: 14, color: colors.primary, fontFamily: FONTS.bodySemiBold, marginTop: 2 },
  alertBanner: { flexDirection: 'row', alignItems: 'center', backgroundColor: colors.warning + '20', paddingHorizontal: 16, paddingVertical: 10, marginHorizontal: spacing.screenPadding, borderRadius: radii.statBox, marginBottom: 12, gap: 8 },
  alertBannerText: { fontSize: 13, color: colors.warning, fontFamily: FONTS.bodySemiBold, flex: 1 },
  ...
  teamChipText: { fontSize: 14, color: colors.textMuted, fontFamily: FONTS.bodySemiBold },
  ...
  viewBtnText: { fontSize: 14, color: colors.textMuted, fontFamily: FONTS.bodyMedium },
  ...
  legendText: { fontSize: 12, color: colors.textMuted, fontFamily: FONTS.bodyMedium },
  content: { flex: 1 },
  ...
  orderBtnText: { fontSize: 11, color: colors.warning, fontFamily: FONTS.bodySemiBold },
  emptyState: { alignItems: 'center', paddingVertical: 60 },
  emptyText: { fontSize: 16, color: colors.textMuted, fontFamily: FONTS.bodySemiBold, marginTop: 12 },
  emptySubtext: { fontSize: 13, color: colors.textMuted, fontFamily: FONTS.bodyMedium, marginTop: 4 },
  ...
  modalContent: {},
  modalPlayerName: { ...displayTextStyle, fontSize: 24, color: colors.text, textAlign: 'center', marginBottom: 20 },
  modalLabel: { fontSize: 12, color: colors.textMuted, fontFamily: FONTS.bodyBold, marginBottom: 8, marginTop: 16, textTransform: 'uppercase' as const, letterSpacing: 1 },
  ...
  prefBadgeText: { fontSize: 13, color: colors.text, fontFamily: FONTS.bodyMedium },
  numberInput: { backgroundColor: colors.background, borderRadius: 12, padding: 16, fontSize: 32, fontFamily: FONTS.bodyBold, color: colors.text, textAlign: 'center', borderWidth: 2, borderColor: colors.primary },
