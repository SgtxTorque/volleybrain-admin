...
const createStyles = (colors: any) => StyleSheet.create({
  ...
  label: { fontSize: 12, color: colors.textMuted, fontFamily: FONTS.bodyBold, marginBottom: 8, marginTop: 16, textTransform: 'uppercase' as const, letterSpacing: 1 },
  ...
  syncBtnTxt: { color: colors.info, fontSize: 16, fontFamily: FONTS.bodySemiBold },
  section: { backgroundColor: colors.background, borderRadius: 12, padding: 16, marginBottom: 16 },
  sectionTitle: { fontSize: 16, fontFamily: FONTS.bodyBold, color: colors.primary, marginBottom: 12 },
  ...
  memberInitials: { color: colors.primary, fontSize: 14, fontFamily: FONTS.bodyBold },
  memberInfo: { flex: 1 },
  memberName: { fontSize: 16, fontFamily: FONTS.bodySemiBold, color: colors.text },
