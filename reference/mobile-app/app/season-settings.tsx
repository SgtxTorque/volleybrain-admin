...
const createStyles = (colors: any) => StyleSheet.create({
  ...
  emptyText: { color: colors.textSecondary, fontSize: 16, fontFamily: FONTS.bodyMedium, marginTop: 12 },
  ...
  sportBadgeText: { fontSize: 14, fontFamily: FONTS.bodySemiBold, marginLeft: 8 },
  ...
  alertTitle: { color: '#E8913A', fontFamily: FONTS.bodyBold, fontSize: 14, marginLeft: 8 },
  alertDescription: { color: colors.text, fontSize: 13, fontFamily: FONTS.bodyMedium, marginBottom: 8 },
  ...
  alertItemText: { color: colors.text, fontSize: 13, fontFamily: FONTS.bodyMedium },
  alertItemCount: { color: '#E8913A', fontSize: 13, fontFamily: FONTS.bodySemiBold },
  alertMore: { color: colors.textSecondary, fontSize: 12, marginTop: 8, textAlign: 'center' },

  statsRow: { flexDirection: 'row', gap: 8, marginBottom: 16 },
  statCard: { flex: 1, backgroundColor: colors.card, borderRadius: radii.card, padding: 16, alignItems: 'center', borderWidth: 1, borderColor: colors.border, ...shadows.card },
  statNumber: { ...displayTextStyle, fontSize: 28, color: colors.text },
  statLabel: { fontSize: 12, color: colors.textSecondary, fontFamily: FONTS.bodyMedium, marginTop: 4 },

  toggleCard: { flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', backgroundColor: colors.card, borderRadius: radii.card, padding: 16, marginBottom: 16, borderWidth: 1, borderColor: colors.border, ...shadows.card },
  toggleInfo: { flexDirection: 'row', alignItems: 'center', flex: 1 },
  toggleText: { marginLeft: 12 },
  toggleTitle: { fontSize: 16, fontFamily: FONTS.bodySemiBold, color: colors.text },
  toggleSubtitle: { fontSize: 13, color: colors.textSecondary, fontFamily: FONTS.bodyMedium, marginTop: 2 },
  ...
  sectionTitle: { fontSize: 13, fontFamily: FONTS.bodyBold, color: colors.textMuted, marginBottom: 12, textTransform: 'uppercase', letterSpacing: 1.2 },
  sectionSubtitle: { fontSize: 14, color: colors.primary, fontFamily: FONTS.bodySemiBold },
  card: { backgroundColor: colors.card, borderRadius: radii.card, overflow: 'hidden', borderWidth: 1, borderColor: colors.border, ...shadows.card },
  divider: { height: 1, backgroundColor: colors.border, marginHorizontal: 16 },

  settingRow: { flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', padding: 16 },
  settingInfo: { flex: 1 },
  settingLabel: { fontSize: 15, color: colors.text, fontFamily: FONTS.bodySemiBold },
  settingDesc: { fontSize: 12, color: colors.textSecondary, fontFamily: FONTS.bodyMedium, marginTop: 2 },
  settingValue: { fontSize: 14, color: colors.textSecondary, fontFamily: FONTS.bodyMedium },
  settingAmount: { fontSize: 16, color: colors.primary, fontFamily: FONTS.bodySemiBold },

  ageGroupRow: { flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', padding: 16 },
  ageGroupInfo: { flex: 1 },
  ageGroupName: { fontSize: 15, color: colors.text, fontFamily: FONTS.bodySemiBold },
  ageGroupMeta: { fontSize: 12, color: colors.textSecondary, fontFamily: FONTS.bodyMedium, marginTop: 2 },
  ...
  teamName: { fontSize: 15, color: colors.text, fontFamily: FONTS.bodySemiBold },
  teamBadge: { flexDirection: 'row', alignItems: 'center', paddingHorizontal: 8, paddingVertical: 2, borderRadius: 8 },
  teamBadgeText: { fontSize: 11, fontFamily: FONTS.bodySemiBold, marginLeft: 4 },
  teamCount: { fontSize: 16, fontFamily: FONTS.bodySemiBold },
  viewAllBtn: { padding: 16, alignItems: 'center', borderTopWidth: 1, borderTopColor: colors.border },
  viewAllText: { color: colors.primary, fontSize: 14, fontFamily: FONTS.bodySemiBold },

  addButton: { flexDirection: 'row', alignItems: 'center' },
  addButtonText: { fontSize: 14, color: colors.primary, fontFamily: FONTS.bodySemiBold },
  emptyCard: { backgroundColor: colors.card, borderRadius: radii.card, padding: 24, alignItems: 'center', borderWidth: 1, borderColor: colors.border, ...shadows.card },
  emptyCardText: { color: colors.textSecondary, fontSize: 14, fontFamily: FONTS.bodyMedium },
  emptyCardButton: { marginTop: 12, paddingHorizontal: 16, paddingVertical: 8, backgroundColor: colors.primary + '20', borderRadius: 8 },
  emptyCardButtonText: { color: colors.primary, fontFamily: FONTS.bodySemiBold },

  modalOverlay: { flex: 1, backgroundColor: 'rgba(0,0,0,0.6)', justifyContent: 'center', alignItems: 'center', padding: 24 },
  
  datePickerModal: { backgroundColor: colors.card, borderRadius: radii.card, padding: 24, width: '100%', maxWidth: 350 },
  datePickerTitle: { ...displayTextStyle, fontSize: 18, color: colors.text, marginBottom: 16, textAlign: 'center' },
  ...
  datePickerCancelText: { color: colors.text, fontFamily: FONTS.bodySemiBold },
  datePickerConfirm: { flex: 1, padding: 14, borderRadius: 12, backgroundColor: colors.primary, alignItems: 'center' },
  datePickerConfirmText: { color: colors.background, fontFamily: FONTS.bodySemiBold },

  editModal: { backgroundColor: colors.card, borderRadius: radii.card, padding: 24, width: '100%', maxWidth: 350 },
  editModalTitle: { ...displayTextStyle, fontSize: 18, color: colors.text, marginBottom: 16, textAlign: 'center' },
  editInput: { backgroundColor: colors.background, borderRadius: 12, padding: 16, fontSize: 18, color: colors.text, fontFamily: FONTS.bodyMedium, borderWidth: 1, borderColor: colors.border, textAlign: 'center' },
  ...
  editModalCancelText: { color: colors.text, fontFamily: FONTS.bodySemiBold },
  editModalSave: { flex: 1, padding: 14, borderRadius: 12, backgroundColor: colors.primary, alignItems: 'center' },
  editModalSaveText: { color: colors.background, fontFamily: FONTS.bodySemiBold },

  ageGroupModal: { backgroundColor: colors.card, borderRadius: radii.card, padding: 24, width: '100%', maxWidth: 400, maxHeight: '80%' },
  ageGroupModalHeader: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', marginBottom: 20 },
  ageGroupModalTitle: { ...displayTextStyle, fontSize: 20, color: colors.text },

  inputLabel: { fontSize: 13, color: colors.textSecondary, fontFamily: FONTS.bodySemiBold, marginBottom: 8, marginTop: 16 },
  textInput: { backgroundColor: colors.background, borderRadius: 12, padding: 14, fontSize: 16, color: colors.text, fontFamily: FONTS.bodyMedium, borderWidth: 1, borderColor: colors.border },
  ...
  typeBtnText: { fontSize: 14, color: colors.textSecondary, fontFamily: FONTS.bodyMedium },
  typeBtnTextSelected: { color: colors.primary, fontFamily: FONTS.bodySemiBold },
  ...
  genderBtnText: { fontSize: 14, color: colors.textSecondary, fontFamily: FONTS.bodyMedium },
  genderBtnTextSelected: { color: colors.primary, fontFamily: FONTS.bodySemiBold },
  ...
  skillBtnText: { fontSize: 13, color: colors.textSecondary, fontFamily: FONTS.bodyMedium },
  skillBtnTextSelected: { color: colors.primary, fontFamily: FONTS.bodySemiBold },

  previewBox: { marginTop: 20, padding: 16, backgroundColor: colors.background, borderRadius: 12, alignItems: 'center' },
  previewLabel: { fontSize: 12, color: colors.textSecondary, fontFamily: FONTS.bodyMedium, marginBottom: 4 },
  previewName: { ...displayTextStyle, fontSize: 18, color: colors.primary },
