...
export const ADMIN_STEPS = [
  ...
  },
  {
    ...
    description: 'Give each rostered player a jersey number. Conflicts are highlighted automatically.',
    completionCheck: (d) => d.jerseyAssignedCount > 0,
    ctaLabel: 'Assign Jerseys',
    navigateTo: '/jerseys',
    blockedUntil: 'process_registrations',
    blockedMessage: 'Approve registrations and assign players to teams first',
  },
  {
