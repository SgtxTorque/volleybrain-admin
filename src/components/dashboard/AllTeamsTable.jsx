        ...
        <table className="w-full text-sm">
          <thead>
            <tr className={isDark ? 'text-slate-500' : 'text-slate-400'}>
              <th className="text-left text-[10px] font-semibold uppercase tracking-wider px-4 py-2">Team</th>
              <th className="text-center text-[10px] font-semibold uppercase tracking-wider px-2 py-2">Record</th>
              <th className="text-center text-[10px] font-semibold uppercase tracking-wider px-2 py-2">Players</th>
              <th className="text-center text-[10px] font-semibold uppercase tracking-wider px-2 py-2">Health</th>
              <th className="text-center text-[10px] font-semibold uppercase tracking-wider px-2 py-2">Status</th>
            </tr>
          </thead>
          <tbody>
            {teams.map(team => {
