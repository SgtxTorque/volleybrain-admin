...
function FormBadge({ result }) {
  ...
  return (
    <span className={`w-6 h-6 rounded-md flex items-center justify-center text-sm font-black ${
    ...
    return (
      <div className="relative rounded-2xl overflow-hidden" style={{ background: 'linear-gradient(135deg, #0B1628 0%, #122240 50%, #0B1628 100%)', minHeight: '240px' }}>
        ...
        <div className="relative z-10 p-6 flex flex-col justify-center h-full">
          <p className="text-sm font-bold uppercase tracking-[1.5px] text-slate-500 mb-2">Season Record</p>
          ...
          <p className="text-base text-slate-400">{selectedTeam?.name} · {winRate}% win rate</p>
        </div>
      </div>
    )
  }
    ...
    <div className="relative rounded-2xl overflow-hidden" style={{ background: 'linear-gradient(135deg, #0B1628 0%, #0F2040 60%, #0B1628 100%)', minHeight: '240px' }}>
      ...
      <div className="relative z-10 p-5 flex gap-6 h-full">
        ...
        <div className="flex-1 flex flex-col justify-center">
          {/* Live badge */}
          {isToday && (
            <span className="inline-flex items-center gap-1.5 px-2.5 py-1 rounded-lg text-sm font-bold uppercase tracking-widest bg-red-500/20 text-red-300 border border-red-500/30 self-start mb-2">
          ...
          {!isToday && countdown && (
            <span className="inline-flex items-center gap-1.5 px-2.5 py-1 rounded-lg text-sm font-bold bg-white/10 text-white/70 self-start mb-2">
          ...
          <button
            ...
            className="inline-flex items-center gap-1.5 px-4 py-2 rounded-xl bg-lynx-sky hover:brightness-110 text-white text-base font-semibold self-start transition"
          >
        ...
        <div className="flex flex-col items-center justify-center min-w-[140px]">
          <p className="text-sm font-bold uppercase tracking-[1.5px] text-slate-500 mb-2">
            Season Record
          </p>
          ...
          <p className="text-sm text-slate-500 mb-2">{winRate}% win rate</p>
