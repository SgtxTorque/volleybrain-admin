    ...
    <button onClick={onClick}
      ...
      <div className="relative flex items-center gap-4 p-5">
        ...
        {child.photo_url ? (
          ...
          <div className="w-20 h-20 rounded-2xl flex items-center justify-center text-white font-black text-3xl border-2 border-white/10 flex-shrink-0"
        ...
        <div className="flex-1 min-w-0">
          <p className="text-[11px] font-bold uppercase tracking-wider text-lynx-sky">
          ...
          <div className="flex items-center gap-3 mt-1.5">
            {jersey && (
              <span className="text-[11px] font-bold uppercase tracking-wider px-2 py-0.5 rounded-full bg-white/10 text-white/70">
                #{jersey}
              </span>
            )}
            <span className="text-[11px] font-bold uppercase tracking-wider px-2 py-0.5 rounded-full bg-white/10 text-white/70">
            ...
            {child.registrationStatus === 'active' && (
              <span className="text-[11px] font-bold uppercase tracking-wider px-2 py-0.5 rounded-full bg-emerald-500/20 text-emerald-400">
                Active
              </span>
            )}
          </div>
    ...
    <div className="flex gap-3 overflow-x-auto pb-2 -mx-1 px-1 scrollbar-hide">
      ...
      {onAddChild && (
        <button onClick={onAddChild}
          ...
          <span className="text-[11px] font-bold uppercase tracking-wider">Add Child</span>
        </button>
      )}
    </div>
  )
