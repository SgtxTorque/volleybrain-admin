  ...
  if (size === 'large') {
    return (
      <div className="bg-white rounded-2xl p-6 border border-slate-200 shadow-sm">
        ...
        <p className="text-4xl font-bold text-slate-800" style={{ color }}>{value}</p>
  ...
  return (
    <div className="bg-slate-50 rounded-xl p-4">
      <div className="flex items-center justify-between mb-1">
        ...
        {trend && (
          <span className={`text-xs ${isPositive ? 'text-emerald-600' : isNegative ? 'text-red-600' : 'text-slate-500'}`}>
...
function GameHistoryRow({ game, stats, onClick }) {
  ...
  return (
    <div 
      onClick={onClick}
      className="flex items-center gap-4 p-4 bg-white rounded-xl border border-slate-200 hover:border-indigo-300 hover:shadow-md transition cursor-pointer"
    >
      {/* Date */}
      <div className="text-center min-w-[60px]">
        <p className="text-xs text-slate-500 uppercase">{gameDate.toLocaleDateString('en-US', { month: 'short' })}</p>
        <p className="text-2xl font-bold text-slate-800">{gameDate.getDate()}</p>
      </div>
      ...
      <div className="flex-1 min-w-0">
        <p className="font-semibold text-slate-800 truncate">vs {game.opponent_name || 'Unknown'}</p>
      ...
      <div className="flex gap-4 text-center">
        <div>
          ...
          <p className="text-[10px] text-slate-500">Aces</p>
        </div>
        <div>
        ...
        <div>
          ...
          <p className="text-[10px] text-slate-500">Digs</p>
        </div>
        <div>
          ...
          <div className="space-y-6">
            ...
            <div className="grid md:grid-cols-2 gap-6">
              ...
              <div className="bg-white rounded-2xl p-6 border border-slate-200 shadow-sm">
                ...
                <p className="text-xs text-slate-500 mt-2 text-center">Last {gameHistory.length} games</p>
              </div>
              ...
              <div className="grid md:grid-cols-2 gap-6">
                <div>
                  <div className="flex justify-between mb-2">
                    <span className="text-slate-600">Hitting Percentage</span>
                  ...
                  <p className="text-xs text-slate-500 mt-1">(Kills - Errors) / Attempts</p>
                </div>
                
                <div>
                  <div className="flex justify-between mb-2">
                    <span className="text-slate-600">Serve Percentage</span>
                    <span className="font-bold text-slate-800">
                  ...
                  <p className="text-xs text-slate-500 mt-1">(Serves - Errors) / Serves</p>
                </div>
              </div>
            </div>
          </div>
        ...
        {activeTab === 'game-log' && (
          <div className="space-y-4">
            <div className="flex items-center justify-between">
              <h2 className="text-lg font-bold text-slate-800">Game History</h2>
              <span className="text-sm text-slate-500">{gameHistory.length} games</span>
            </div>
          ...
          <div className="space-y-6">
            ...
            <div className="bg-white rounded-2xl p-6 border border-slate-200 shadow-sm">
              ...
              {skillRatings ? (
                <div className="grid md:grid-cols-2 gap-6">
                  <div className="space-y-4">
                    <h4 className="font-semibold text-slate-700">Technical Skills</h4>
                  ...
                  <div className="space-y-4">
                    <h4 className="font-semibold text-slate-700">Intangibles</h4>
                    ...
                    <div className="mt-6 p-4 bg-gradient-to-r from-indigo-50 to-purple-50 rounded-xl">
                      <div className="flex items-center justify-between">
                        <span className="font-semibold text-indigo-800">Overall Rating</span>
            ...
            {skillRatings?.coach_notes && (
              <div className="bg-white rounded-2xl p-6 border border-slate-200 shadow-sm">
                ...
                <p className="text-slate-600 whitespace-pre-wrap">{skillRatings.coach_notes}</p>
              </div>
            )}
          </div>
        )}
