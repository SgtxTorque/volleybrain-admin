...
function SeasonsPage({ showToast }) {
  ...
  const [form, setForm] = useState({
    ...
    early_bird_deadline: '', early_bird_discount: orgSettings.early_bird_discount ?? 0,
  ...
  function openEdit(season) {
    ...
    setForm({
      ...
      fee_registration: season.fee_registration ?? orgSettings.default_registration_fee ?? 150,
      fee_uniform: season.fee_uniform ?? orgSettings.default_uniform_fee ?? 45,
      fee_monthly: season.fee_monthly ?? orgSettings.default_monthly_fee ?? 50,
      ...
      early_bird_discount: season.early_bird_discount ?? orgSettings.early_bird_discount ?? 0,
